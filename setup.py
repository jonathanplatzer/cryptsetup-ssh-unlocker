...
if sys.version_info[:2] < (3, 6):
    sys.exit('ssh-unlocker requires Python 3.6 or higher, sorry. Please consider using `pyenv` if your distribution does not provide Python 3.6+')
...
setup(
    ...
    install_requires=['asyncssh>=2,<3', 'bcrypt>=3.1'],
    classifiers=[
